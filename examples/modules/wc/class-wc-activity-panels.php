<?php
/**
 * Module Name: WC Activity Panels
 * Module URI: https://github.com/thefarside/configurator/tree/main/examples/modules/wc/class-wc-activity-panels.php
 * Version: 0.0.1
 * Description: Disables WooCommerce "Activity Panels".
