<?php
/**
 * Module Name: WC Reviews
 * Module URI: https://github.com/thefarside/configurator/tree/main/examples/modules/wc/class-wc-reviews.php
 * Version: 0.0.1
 * Description: Disables WooCommerce product "Reviews" and related GUI elements.
