<?php
/**
 * Module Name: Disabled Usernames
 * Module URI: https://github.com/thefarside/configurator/tree/main/examples/modules/class-disabled-usernames.php
 * Version: 0.0.1
 * Description: Enables editing the username field on user profile pages.
 * Requires at least: 7.0
 * Requires PHP: 8.5.1
 * Requires Modules: Configurator\Helpers\DOMXPath, \DOMDocument, \stdClass, \WP_Error
 */
