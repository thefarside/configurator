<?php
/**
 * Module Name: GDPR Erase Template
 * Module URI: https://github.com/thefarside/configurator/tree/main/examples/modules/class-gdpr-erase-template.php
 * Version: 0.0.1
 * Description: Example plugin that templates how to hook into GDPR Erase.
