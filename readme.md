...
## Installation
 ...
 + Upload necessary configurations
	+ `examples\filters\class-my-filters.php` → `wp-content\mu-plugins\configurator\filters`

> *See `examples\filters\class-example.php` for example module configurations.*
